    ...
    <>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-8 sm:py-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          {/* LIVE SESSION LOGS */}
          <div className="border rounded-lg p-5 sm:p-6 shadow-sm h-[500px] overflow-y-auto">
          ...
          {/* TREND SIMULATOR */}
          <div className="border rounded-lg p-5 sm:p-6 shadow-sm">
            ...
            <p className="text-xs mt-4 text-gray-500">
              Trends auto-generated from real AI behavioral logs.
            </p>
